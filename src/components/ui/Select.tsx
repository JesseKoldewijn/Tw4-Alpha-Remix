...
const ButtonAriaInteropt = forwardRef<HTMLSelectElement, any>((props, ref) => {
  // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
  const { onClick, ...rest } = props;
  // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
  return <AriaSelect ref={ref} onPress={onClick} {...rest} />;
});
ButtonAriaInteropt.displayName = "SelectAriaInteropt";

const Select = forwardRef<HTMLSelectElement, ButtonProps>(
